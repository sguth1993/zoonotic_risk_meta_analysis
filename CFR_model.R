...
dat.mort$CFR <- (dat.mort$CFR*(87-1) + 0.5)/87
...
write.csv(effect_sizes,"Extension/code_and_data/data/effect_sizes/CFR_effects.csv")
...
colors= c('PRIMATES' ="firebrick1", 
          'PERISSODACTYLA'= "darkorange", 
          'CETARTIODACTYLA'=  "yellowgreen", 
          'CARNIVORA'="forestgreen",  
          #'SCANDENTIA'="darkseagreen1" , 'LAGOMORPHA'="cornflowerblue", 
          'RODENTIA'=  "gray40",  
          'CHIROPTERA'="purple", 
