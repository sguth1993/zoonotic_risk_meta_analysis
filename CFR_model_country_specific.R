...
pub_count_country <- ggplot(plotData_pub_count$effects, aes(x = log(VirusSppPublicationCount), y = y, colour = IsSignificant, fill = IsSignificant)) +
  geom_hline(yintercept = 0, linetype = 2, colour = 'grey20') +
  ...
  scale_fill_manual(values = c(No = 'grey60', Yes = '#225ea8'), guide = F) +
  scale_y_continuous(labels = function(x) sprintf('%1.1f', x) ) +
  labs(x = "log(virus species\npublication count)", y = 'Effect on country-specific\n CFR in humans') +
  theme_bw() +
  theme(axis.title = element_text(size = 12),
...
GDP <- ggplot(plotData_GDP$effects, aes(x = weighted_GDP, y = y, colour = IsSignificant, fill = IsSignificant)) +
  geom_hline(yintercept = 0, linetype = 2, colour = 'grey20') +
  geom_jitter(aes(y = Residual), alpha = 0.6, size = 0.8,
              width = 3, height = 0,
  ...
  scale_fill_manual(values = c(No = 'grey60', Yes = '#225ea8'), guide = F) +
  scale_y_continuous(labels = function(x) sprintf('%1.1f', x) ) +
  labs(x = "composite GDPPC", y = 'Effect on country-specific\n CFR in humans') +
  theme_bw() +
  theme(axis.title = element_text(size = 12),
        axis.text.x = element_text(size = 11),
        axis.text.y = element_text(size = 10),
...
Fig1a_country <- cowplot::plot_grid(CFR_country_models, hOrder_country, vFamily_country, 
                                    GDP, binary_country, pub_count_country, 
