...
CFR_model_serology.R ... script used for the global estimate CFR GAM, including viruses that met a loose definition of zoonotic, presented in Table S6b and Figure S3

CFR_model_country_specific.R ... script used for the country-specific CFR GAM presented in Table S6c and Figure S4
...
death_burden_model.R  ... script used for the death burden GAM presented in Table S6e and Figure S9

Mollentze_functions.R ... functions published by Mollentze et al. 2020 that were applied in the above scripts

pre_analysis_calculations.R ... script used to prepare collected data for analysis
